...
void Navigator::createCentralWidget() {
    ...
    newStudyButton = new QPushButton(QPixmap::fromMimeSource("hi32-newstudy.png"),
        "" , buttonFrame);
    newStudyButton->setMinimumHeight(BUTTON_SIZE);
...
//    buttonGridLayout->addWidget(newStudyButton, 0, 0);
    ...
    continueStudyButton = new QPushButton(QPixmap::fromMimeSource("hi32-continuestudy.png"),
        "", buttonFrame);
    continueStudyButton->setMinimumHeight(BUTTON_SIZE);
 ...
 //   buttonGridLayout->addWidget(continueStudyButton, 1, 0);
    ...
    reviewStudyButton = new QPushButton(QPixmap::fromMimeSource("hi32-reviewstudy.png"),
        "", buttonFrame);
    reviewStudyButton->setMinimumHeight(BUTTON_SIZE);
...
//    buttonGridLayout->addWidget(reviewStudyButton, 2, 0);
    ...
    preregisterPatientButton = 
        ...
        "", buttonFrame);
    preregisterPatientButton->setMinimumHeight(BUTTON_SIZE);
...
//    buttonGridLayout->addWidget(preregisterPatientButton, 3, 0);
    ...
    reportsButton = new QPushButton(QPixmap::fromMimeSource("hi32-reports.png"),
        "", buttonFrame);
    reportsButton->setMinimumHeight(BUTTON_SIZE);
